                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="mb-3">
                            <div class="d-flex align-items-center mb-4 pb-3 justify-content-end flex-wrap">
                                <div class="me-3">
                                    <h4 class="fs-18 font-w600">PPDB YBS</h4>
                                    <span>Jl KarangJaya, Tirtamulya,Karawang <br>Jawa Barat 41732 Indonesia</span>
                                </div>
                                <div class="me-3">
                                        ...
                                        <th colspan="3" scope="row">
                                            ...
                                            @foreach ($viewData as $x)
                                                    ...
                                                    <div class="alert alert-danger solid alert-rounded" style="border-radius: 0%">
                                                        ...
                                                        Peserta Didik Baru, Silahkan coba kembali, Jangan Menyerah Ya!
                                                    </div>
