        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                ...
                <div class="copyright">
                    <p><strong> Olengs Bergerak </strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved</p>
                    <p class="fs-12">Made with <span class="heart"></span> by Team Olengs</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/teamoleng5/" target="_blank">Team Olengs</a>
                </p>
            </div>
        </div>
        <!--**********************************
