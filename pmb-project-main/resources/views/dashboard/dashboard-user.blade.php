...
<div class="row page-titles" style="border-radius: 0%">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="javascript:void(0)">PPDB YBS</a></li>
    </ol>
</div>
<div class="row">
    <div class="col-xl-7">
                                                ...
                                                <div id="about-me" class="tab-pane fade active show">
                                                    <div class="profile-personal-info">
                                                        ...
                                                        <ul class="list-inline">
                                                            <li class="list-inline-item">Siswa kelas IX SMP/MTS/Sederajat lulus pada tahun berjalan.</li>
